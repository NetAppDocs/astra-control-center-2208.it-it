...
* Replica dell'applicazione su un sistema remoto utilizzando la tecnologia NetApp SnapMirror
...
Astra Control Center supporta i cluster Kubernetes con:
...
* Rileva i dettagli del cluster, inclusi gli spazi dei nomi, e consente di definire e proteggere le applicazioni.
